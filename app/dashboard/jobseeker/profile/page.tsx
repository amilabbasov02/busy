    ...
    <>
      <div className="row">
        <form method="post" encType="multipart/form-data" style={{ width: '100%' }}>
          ...
          <div className="col-xl-12">
            <button type="submit" className="button ripple-effect big margin-top-30">Yadda saxla</button>
            <button type="submit" className="button ripple-effect big margin-top-30" style={{ marginLeft: '10px' }}>Yadda saxla &amp; Davam et→</button>
          </div>
        </form>
      </div>
    </>
