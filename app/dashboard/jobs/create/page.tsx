        ...
        <div className="dashboard-content-inner" style={{ minHeight: '871px' }}>
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="dashboard-box margin-top-0">
                <div className="headline">
                  <h3><i className="icon-feather-folder-plus"></i> Vakansiya əlavə et</h3>
                </div>
                <form action="/dashboard/jobs/create" id="jobs_form" method="post" encType="multipart/form-data" noValidate>
                  <input type="hidden" name="_token" value="8cczRj80IVUmjkmgUD3aliAxVixqRatfhi5DGK7I" />
                  <div className="content with-padding padding-bottom-10">
                    <div className="row">
                      <div className="col-xl-8">
                        <div className="submit-field">
                          <h5>Vakansiyanın adı</h5>
                          <input type="text" name="job_title" value={formData.job_title} onChange={handleChange} data-tippy-content="Vakansiyanın adı" placeholder="Vakansiyanın adı" required className="with-border" />
                        </div>
                      </div>
                      <div className="col-xl-4">
                        <div className="submit-field" style={{ display: 'block' }} id="employment_type_div">
                          <h5>İş tipi</h5>
                          <BootstrapSelect className="selectpicker with-border" data-size="7" data-tippy-content="İş tipi" name="employment_type" value={formData.employment_type} onChange={handleChange} required title="İş tipi">
                            <option value="">İş tipi</option>
            ...
            <div className="col-xl-12 margin-bottom-10">
              <button type="submit" className="button ripple-effect big margin-top-30" name="send" style={{ float: 'right' }}>
                <i className="icon-feather-plus"></i> Vakansiya əlavə et
              </button>
            </div>
          </div>
        </div>
