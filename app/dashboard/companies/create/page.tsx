            ...
            <div className="col-xl-12">
              <div className="dashboard-box margin-top-0">
                <div className="headline">
                  <h3><i className="icon-material-outline-business-center"></i> Şirkət yarat</h3>
                </div>
                <form action="/dashboard/companies/create" method="post" id="company_form" encType="multipart/form-data" noValidate>
                  <div className="content with-padding padding-bottom-10">
                    <div className="row">
                      ...
                      <div className="col-xl-6">
                        <div className="submit-field">
                          <h5>Linkedin</h5>
                          <input type="url" name="linkedin" className="with-border" id="linkedin" placeholder="https://" value={formData.linkedin} onChange={handleChange} />
                        </div>
                      </div>
                      <div className="col-xl-6">
                        <div className="submit-field">
