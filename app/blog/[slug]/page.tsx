...
const API_BASE_URL = 'https://api.busy.az';
    ...
    useEffect(() => {
        ...
        async function fetchPost() {
            ...
            try {
                ...
                if (!response.ok) throw new Error('Post tapılmadı');
        ...
        <>
            ...
            <div className={styles.container}>
                <main>
                    ...
                    <article className={styles.articleContent} style={{ fontSize: `${fontSize}rem` }} dangerouslySetInnerHTML={{ __html: post.content }} />
