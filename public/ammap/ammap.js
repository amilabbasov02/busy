        ...
        afterWrite: function (a) {
            ...
            if ((b = "object" != typeof a ? document.getElementById(a) : a)) {
                ...
                if (e) {
                    ...
                    if (e.enabled)
                        switch (
                            ((g.left = null), (g.top = null), (g.right = null), (f.left = null), (f.right = null), (f.top = null), (g.position = "relative"), (f.position = "relative"), (h.width = "100%"), (h.height = "100%"), e.position)
                            ) {
                            case "bottom":
                                k.appendChild(a);
                                k.appendChild(c);
        ...
        draw: function () {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    "H" != u
                        ? ((x = a - z / 2), b < k + v + 10 && "down" != u ? ((H = !0), e && (b += A), (A = b + B), (this.deltaSignY = -1)) : (e && (b -= A), (A = b - v - B), (this.deltaSignY = 1)))
                        : (2 * B > v && (B = v / 2), (A = b - v / 2), a < h + (l - h) / 2 ? ((x = a + B), (this.deltaSignX = -1)) : ((x = a - z - B), (this.deltaSignX = 1)));
                    A + v >= m && (A = m - v);
                    A < k && (A = k);
                    x < h && (x = h);
                    x + z > l && (x = l - z);
                    ...
                    this.drop
                        ...
                        "right" == u && ((l = 90), (x = a - h - h / 3 + 2), (A = b)),
                            (k = A - F / 2 + 1),
                            (m = x - E / 2 - 1),
                            (p = d.drop(g, h, l, p, y, q, r, M)))
                        : 0 < w || 0 === B
                        ? (0 < G && ((a = d.rect(g, z, v, p, 0, q + 1, D, G, w)), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), (p = d.rect(g, z, v, p, y, q, r, M, w)))
                        : ((t = []),
                            (w = []),
                            "H" != u
                                ? ((h = a - x), h > z - B && (h = z - B), h < B && (h = B), (t = [0, h - B, a - x, h + B, z, z, 0, 0]), (w = H ? [0, 0, b - A, 0, 0, v, v, 0] : [v, v, b - A, v, v, 0, 0, v]))
                                : ((u = b - A),
                                u > v - B && (u = v - B),
                                u < B && (u = B),
                                    (w = [0, u - B, b - A, u + B, v, v, 0, 0]),
                                    (t = a < h + (l - h) / 2 ? [0, 0, x < a ? 0 : a - x, 0, 0, z, z, 0] : [z, z, x + z > a ? z : a - x, z, z, 0, 0, z])),
                        0 < G && ((a = d.polygon(g, t, w, p, 0, q, D, G)), a.translate(1, 1), f.push(a)),
                            (p = d.polygon(g, t, w, p, y, q, r, M)));
                    this.bg = p;
                    f.push(p);
                    p.toFront();
                    ...
                    ((C.left = this.prevTX + "px"),
                        ...
                        (this.yAnim = c.animate({ node: n }, "top", this.prevTY, k, b, "easeOutSine", "px"))));
                    this.prevX = x - g;
                    this.prevY = A;
                    this.prevTX = m;
                    this.prevTY = k;
...
(function () {
    ...
    d.polygon = function (a, b, c, e, g, f, h, k, l, m, n) {
        ...
        void 0 === h && (h = p);
        g = { fill: p, stroke: h, "fill-opacity": g, "stroke-width": f, "stroke-opacity": k };
        ...
        m && (h = Number);
        k = "M" + (h(b[0]) + n) + "," + (h(c[0]) + f);
        for (p = 1; p < b.length; p++) m && ((b[p] = d.roundTo(b[p], 5)), (c[p] = d.roundTo(c[p], 5))), (k += " L" + (h(b[p]) + n) + "," + (h(c[p]) + f));
        a = a.path(k + " Z").attr(g);
    ...
    d.rect = function (a, b, c, e, g, f, h, k, l, m, n) {
        ...
        t += d.dx;
        q += d.dy;
        g = { fill: p, stroke: h, "fill-opacity": g, "stroke-opacity": k };
        void 0 !== n && 0 < n && (g["stroke-dasharray"] = n);
    ...
    d.bullet = function (a, b, c, e, g, f, h, k, l, m, n, p, r) {
        ...
        switch (b) {
            case "round":
                ...
                break;
            case "square":
                t = d.polygon(a, [-c / 2, c / 2, c / 2, -c / 2], [c / 2, c / 2, -c / 2, -c / 2], e, g, f, h, k, m - 180, void 0, r);
                break;
            case "rectangle":
    ...
    d.wedge = function (a, b, c, e, g, f, h, k, l, m, n, p, r, t) {
        ...
        if (0 < l) {
            D = " M" + u + "," + (v + l) + " L" + A + "," + (C + l);
            B
                ? (G || (D += " A" + (b - f) + "," + (l + c - h) + "," + (b + f) + "," + (l + c + h) + "," + A + "," + (C + l) + "," + x + "," + (z + l)),
                    (D += " L" + E + "," + (w + l)),
                0 < k && (G || (D += " B" + (b - k) + "," + (l + c - y) + "," + (b + k) + "," + (l + c + y) + "," + E + "," + (l + w) + "," + u + "," + (l + v))))
                : ((D += " A" + f + "," + h + ",0," + H + ",1," + x + "," + (z + l) + " L" + E + "," + (w + l)), 0 < k && (D += " A" + k + "," + y + ",0," + H + ",0," + u + "," + (v + l)));
            D += " Z";
            var L = l;
            B && (L /= 10);
        ...
        B
            ? (G || (g = " A" + q(b - f) + "," + q(c - h) + "," + q(b + f) + "," + q(c + h) + "," + q(A) + "," + q(C) + "," + q(x) + "," + q(z)), (h = " M" + q(u) + "," + q(v) + " L" + q(A) + "," + q(C) + g + " L" + q(E) + "," + q(w)))
            : (h = " M" + u + "," + v + " L" + A + "," + C + (" A" + f + "," + h + ",0," + H + ",1," + x + "," + z) + " L" + E + "," + w);
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function () {
            ...
            for (v = 0; v < u.length; v++) {
                ...
                w = E.getBBox();
                var F;
                this.equalWidths ? (F = A * (r + n + this.markerLabelGap)) : ((F = C), (C = C + w.width + f + n));
                F + w.width > p && 0 < v && 0 !== A && (t++, (F = A = 0), (C = F + w.width + f + n), (x = x + z + m), (z = 0));
        ...
        createEntry: function (a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (e) {
                    ...
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e)
                        ...
                        a.hidden || ((f = a.lineColorR), (k = a.bulletBorderColorR)),
                            ...
                            m.push(t),
                        a.bullet &&
                        (a.hidden || (f = a.bulletColorR), (t = d.bullet(p, a.bullet, a.bulletSize, f, a.bulletAlpha, a.bulletBorderThickness, k, a.bulletBorderAlpha))) &&
                ...
                "none" != k &&
                0 < r &&
                ("x" == k ? ((u = b.createX()), u.translate(r / 2, r / 2)) : (u = b.createV()),
                    (u.dItem = a),
                ...
                ((f = d.fixBrakes(f)),
                    (a.legendTextReal = f),
                    (w = b.labelWidth),
                    (w = isNaN(w) ? d.text(b.container, f, k, c.fontFamily, l, "start") : d.wrappedText(b.container, f, k, c.fontFamily, l, "start", !1, w, 0)),
                ...
                for (c = 0; c < a.length; c++) {
                    ...
                    if (e) f.value ? g.text(f.value) : g.text("");
                        ...
                        if (void 0 !== f.type) {
                            ...
                            k
                                ? ((h = this.valueText), f.legendValueText && (h = f.legendValueText), f.legendValueTextR && (h = f.legendValueTextR), (h = b.formatString(h, k)))
                                : l && b.formatPeriodString && ((l = d.massReplace(l, { "[[title]]": f.title })), (h = b.formatPeriodString(l, f)));
    ...
    d.AmMap = d.Class({
        ...
        handleMouseMove: function (a) {
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if ((a = b.mapContainer)) {
                    ...
                    if (!isNaN(k)) {
                        b.stopDrag();
                        var t = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - f, 2)),
                            q = b.initialDistance;
                        ...
                        if (!isNaN(q)) {
                            ...
                            0.1 < Math.abs(k - h) && (b.zoomTo(k, q, l, !0), (b.mapWasPinched = !0), clearTimeout(b.pinchTO));
                        }
                    }
                    k = a.scale;
                    b.isDragging &&
                    (b.balloon.hide(0),
                        ...
                        (c = a.x + (g - c)),
                        (e = a.y + (f - e)),
                    b.preventDragOut && ((r = -r * k + m / 2 - b.diffY * b.mapScale * k), (m = m / 2 - b.diffY * b.mapScale * k), (c = d.fitToBounds(c, -p * k + n / 2, n / 2)), (e = d.fitToBounds(e, r, m))),
        ...
        returnInitialColorReal: function (a) {
            ...
            if (b) {
                ...
                ((c = 1), this.areasSettings.adjustOutlineThickness && (c = this.zoomLevel() * this.mapScale), b.setAttr("stroke", h), b.setAttr("stroke-width", f / c), b.setAttr("fill-opacity", e), b.setAttr("stroke-opacity", g));
        ...
        zoomToRectangle: function (a, b, c, e) {
            var g = this.realWidth,
                ...
                h = this.mapSet.scale,
                k = this.zoomControl,
                g = d.fitToBounds(c / g > e / f ? (0.8 * g) / (c * h) : (0.8 * f) / (e * h), k.minZoomLevel, k.maxZoomLevel);
        ...
        zoomToLatLongRectangle: function (a, b, c, e) {
            var g = this.dataProvider,
                ...
                f = d.fitToBounds(h / l > k / g ? (0.8 * l) / h : (0.8 * g) / k, f.minZoomLevel, f.maxZoomLevel);
        ...
        zoomToObject: function (a) {
            if (a) {
                ...
                ((g = a.displayObject.getBBox()),
                    ...
                    (e = g.width * f),
                    (g = g.height * f),
                    (k = a.autoZoomReal && isNaN(a.zoomLevel) ? (e / k > g / l ? (0.8 * k) / e : (0.8 * l) / g) : a.zoomLevel),
                    (l = this.zoomControl),
                    (k = d.fitToBounds(k, l.minZoomLevel, l.maxZoomLevel)),
                isNaN(a.zoomX) && isNaN(a.zoomY) && isNaN(a.zoomLatitude) && isNaN(a.zoomLongitude) && this.zoomToMapXY(k, b + e / 2, c + g / 2));
        ...
        rollOutMapObject: function (a, b) {
            this.hideBalloon();
            a && this.chartCreated && a.isOver && (this.checkIfSelected(a) || this.returnInitialColor(a), this.fire({ type: "rollOutMapObject", mapObject: a, chart: this, event: b }));
        },
        formatString: function (a, b) {
            ...
            var h = b.customData;
            void 0 == h && (h = "");
            return (a = d.massReplace(a, { "[[title]]": g, "[[value]]": f, "[[percent]]": c, "[[description]]": e, "[[customData]]": h }));
        },
...
(function () {
    ...
    d.ZoomControl = d.Class({
        ...
        init: function (a, b) {
            ...
            isNaN(c.bottom) || ((z = a.getY(c.bottom, !0)), f && (z -= q + 3 * g), (z = h ? z - 3 * g : c.homeButtonEnabled ? z - 0.5 * g : z + g));
            e.translate(x, z);
            c.previousDY = NaN;
            var E,
                x = g / 4 - 1;
            if (f) {
                ...
                z.init(b, g, g, k, l, m, n, p, r, t, w, v, A);
            ...
            E && E.translate(g, 4 * g),
                ...
                y.init(b, g, g, k, l, m, n, p, r, t, w, v, A),
                y.set.translate(0, g),
            ...
            c.panControlEnabled && (p = l = 0),
                h.init(b, g, g, k, l, m, n, p, r, t, w, v, A),
                c.panControlEnabled ? h.set.translate(g, g) : E && E.translate(0, 1.5 * g),
        ...
        update: function () {
            ...
            h &&
            (this.isDragging
                ? (h.stopDrag(), (f = e.y + (h.mouseY - this.previousY)), (f = d.fitToBounds(f, g, this.realGridHeight + g)), h.zoomTo(100 * Math.pow(a, c - (f - g) / b), NaN, NaN, !0))
                : ((a = Math.log(h.zoomLevel() / 100) / Math.log(a)), (f = (c - a) * b + g)),
...
(function () {
    ...
    d.SimpleButton = d.Class({
        construct: function () {},
        init: function (a, b, c, e, g, f, h, k, l, m, n, p, r) {
            var t = this;
            t.rollOverColor = m;
            t.color = e;
            t.container = a;
        ...
        init: function (a, b) {
            ...
            if (c.enabled) {
                ...
                var f = c.borderThickness,
                    h = c.borderColor,
                    k = d.rect(b, c.width + f, c.height + f, c.backgroundColor, c.backgroundAlpha, f, h, c.borderAlpha);
                ...
                isNaN(c.bottom) || ((l = a.getY(c.bottom, !0) - c.height - f), (q = c.height - k + f / 2));
...
(function () {
    ...
    d.AreasProcessor = d.Class({
        ...
        process: function (a) {
            ...
            b.maxValueReal = h;
            b.minValueReal = k;
            for (d = 0; d < c; d++) (g = a[d]), isNaN(g.value) ? (g.percents = void 0) : ((g.percents = ((g.value - k) / f) * 100), k == h && (g.percents = 100));
    ...
    d.ImagesProcessor = d.Class({
        ...
        createImage: function (a, b) {
            ...
            if (n) {
                ...
                u
                    ...
                    ((D = e.path(B)),
                        (u = D.getBBox()),
                        a.centeredReal ? ((E = -u.x * w - (u.width * w) / 2), isNaN(a.right) || (E = -E), (q = -u.y * w - (u.height * w) / 2), isNaN(a.bottom) || (q = -q)) : (E = q = 0),
                        D.translate(E, q, w, !0),
                        (D.x = E),
                        (D.y = q));
            D &&
            ...
            0 < G &&
            ((l = D.getBBox()), (e = d.rect(e, l.width + 16, l.height + 10, k, G)), d.setCN(c, e, "map-image-label-background"), void 0 != a.id && d.setCN(c, e, "map-image-label-background-" + a.id), H.push(e), (a.labelBG = e)),
                (a.imageLabel = D),
                H.push(D),
        ...
        updateSizeAndPosition: function (a) {
            ...
            if (!isNaN(e) && !isNaN(g)) c.translate(e, g, NaN, !0);
                ...
                if (((g = b.coordinatesToXY(k, l)), (e = g.x), (g = g.y), isNaN(p) || (e = p), isNaN(r) || (g = r), a.fixedSize)) {
                    p = a.positionScale;
        ...
        createPredefinedImage: function (a, b, c, e, g, f) {
            ...
            switch (e) {
                ...
                case "bubble":
                    ...
                    break;
                case "hexagon":
                    (g /= Math.sqrt(3)), (k = d.polygon(h, [0.866 * g, 0 * g, -0.866 * g, -0.866 * g, 0 * g, 0.866 * g], [0.5 * g, 1 * g, 0.5 * g, -0.5 * g, -1 * g, -0.5 * g], a, 1, c, b, 1));
            }
            return k;
        },
        reset: function () {
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                if (0 < v.length) {
                    ...
                    if (isNaN(q)) {
                        ...
                        q = x.path(k).attr(B);
                        l = x.path(k).attr({ "fill-opacity": 0, stroke: l, "stroke-width": 5 / n, "stroke-opacity": 0.001, fill: "none" });
                    }
                    ...
                    if ("none" != A) {
                        ...
                        if ("end" == A || "both" == A)
                            (u = v[v.length - 1]),
                                (D = C[C.length - 1]),
                                1 < v.length ? ((B = v[v.length - 2]), (I = C[C.length - 2])) : ((B = u), (I = D)),
                        ...
                        if ("start" == A || "both" == A)
                            (r = v[0]), (N = C[0]), 1 < v.length ? ((u = v[1]), (K = C[1])) : ((u = r), (K = N)), (I = (180 * Math.atan((N - K) / (r - u))) / Math.PI), isNaN(F) || (I -= F), (K = r), (I = 0 > r - u ? I - 90 : I + 90);
                        "middle" == A &&
                        ((u = v[v.length - 1]),
                            (D = C[C.length - 1]),
                            1 < v.length ? ((B = v[v.length - 2]), (I = C[C.length - 2])) : ((B = u), (I = D)),
                            ...
                            (N = I + (D - I) / 2),
                            (I = (180 * Math.atan((D - I) / (u - B))) / Math.PI),
                        isNaN(F) || ((F = H / 2), (G -= Math.sqrt(G * G - F * F)), 0 > w && (G = -G), (F = Math.sin((I / 180) * Math.PI)), -1 == F && (F = 1), (K -= F * G), (N += Math.cos((I / 180) * Math.PI) * G)),
                            (I = 0 > u - B ? I - 90 : I + 90));
                        r = d.polygon(x, t, k, m, p, 1, m, p, void 0, !0);
                        d.setCN(c, q, "map-line-arrow");
                        void 0 != a.id && d.setCN(c, q, "map-line-arrow-" + a.id);
        ...
        getCoordinates: function (a, b) {
            ...
            if (!isNaN(a)) {
                ...
                if (!isNaN(this.arc) && 0 !== this.arc && this.arcRadius) {
                    ...
                    var p = e + (f - e) / 2 + (Math.sqrt(k * k - (l / 2) * (l / 2)) * (g - c)) / l;
                    c = (180 * Math.atan2(e - p, c - h)) / Math.PI;
                    g = (180 * Math.atan2(f - p, g - h)) / Math.PI;
                    180 < g - c && (g -= 360);
    ...
    d.winkel3.invert = function (a, b) {
        ...
        do
            var h = Math.cos(e),
                ...
                y = 0.5 * (2 * B * h * t + c / f) - a,
                w = 0.5 * (B * k + e) - b,
                v = 0.5 * u * (n * q + B * h * r * m) + 0.5 / f,
                A = u * ((p * l) / 4 - B * k * t),
                k = 0.125 * u * (l * t - B * k * n * p),
                m = 0.5 * u * (m * r + B * q * h) + 0.5,
                h = A * k - m * v,
                A = (w * A - y * m) / h,
                y = (y * k - w * v) / h,
                c = c - A,
...
(function () {
    ...
    d.DescriptionWindow = d.Class({
        ...
        show: function (a, b, c, d) {
            var el = document.getElementById("right_map");
            var g = this;
            g.chart = a;
            var f = document.createElement("div");
            f.style.position = "absolute";
            var h = a.classNamePrefix + "-description-";
            f.className = "ammapDescriptionWindow1 " + h + "div";
            g.div = f;
            b.appendChild(f);
            var k = ".gif";
            a.svgIcons && (k = ".svg");
    ...
    d.ValueLegend = d.Class({
        ...
        init: function (a, b) {
            if (this.enabled) {
                ...
                if (this.showAsGradient) (c = d.rect(b, this.width, this.height, [c, e], 1, this.borderThickness, this.borderColor, 1, 0, 0)), d.setCN(a, c, "value-legend-gradient"), c.translate(0, h), f.push(c);
                else
